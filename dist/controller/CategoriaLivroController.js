...
let CategoriaLivroController = class CategoriaLivroController extends tsoa_1.Controller {
    ...
    async listarCategoria(notFound, success) {
        try {
            const categoria = await this.categoriaLivroService.listarCategorias();
            return success(200, new BasicResponseDto_1.BasicResponseDto("Cursos listados com sucesso", categoria));
        }
        catch (error) {
...
], CategoriaLivroController.prototype, "listarCategoria", null);
exports.CategoriaLivroController = CategoriaLivroController = __decorate([
    (0, tsoa_1.Route)("categoria_livro"),
